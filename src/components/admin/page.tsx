      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-4">
          {summaryCards.map((card, index) => (
            <Card key={card.title} className="shadow-lg rounded-2xl border-border/50 overflow-hidden animate-in fade-in-50 duration-500" style={{animationDelay: `${index * 100}ms`}}>
              <Link href={card.href || '#'}>
        ...
        <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-5 animate-in fade-in-50 duration-500 delay-200">
            <Card className="lg:col-span-3 shadow-lg rounded-2xl border-border/50 overflow-hidden">
            ...
            <Card className="lg:col-span-2 shadow-lg rounded-2xl border-border/50 overflow-hidden">
                <CardHeader className="bg-gradient-to-br from-secondary/30 to-transparent">
