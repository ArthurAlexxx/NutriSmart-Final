    ...
    >
      <div className="flex flex-col h-full items-center relative">
        {isFeatureLocked && <SubscriptionOverlay />}
         <div className={cn("w-full max-w-4xl flex-1 flex flex-col h-full", isFeatureLocked && 'blur-md pointer-events-none')}>
            ...
            <Card className="flex-1 flex flex-col border-t-0 sm:border-t rounded-t-2xl sm:rounded-2xl shadow-lg overflow-hidden min-h-0">
                <ChatView
                    messages={messages}
